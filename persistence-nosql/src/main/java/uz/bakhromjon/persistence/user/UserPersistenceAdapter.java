...
public class UserPersistenceAdapter implements SaveUserPort, LoadUserPort {
    ...
    public User save(User user) {
        UserDocument entity = USER_PERSISTENCE_MAPPER.mapToEntity(user);
    ...
    public User loadByEmail(String email) {
        Optional<UserDocument> optional = userRepository.findByEmail(email);
        UserDocument entity = optional.orElseThrow(() -> {
